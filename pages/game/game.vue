	...
	<view class="game-container">
		...
		<view class="controls">
			...
			<view class="right-controls">
				<button class="control-btn jump-btn" @touchstart="onTouchJump" @touchend="onRelease">跳跃</button>
				<button class="control-btn attack-btn" @touchstart="onTouchAttack" @touchend="onRelease">攻击</button>
			</view>
		</view>
...
.pause-menu, .victory-screen, .gameover-screen {
	position: fixed;
	top: 0;
	left: 0;
	width: 100vw;
...
.menu-content, .victory-content, .gameover-content {
...
.menu-title, .victory-title, .gameover-title {
	font-size: 36px;
	font-weight: bold;
	color: white;
}
