# 勇士救公主 - uni-app 横版闯关游戏

一个基于 uni-app 和 Canvas 的横版卷轴闯关游戏，主题为勇士营救被囚禁的公主。支持H5、小程序等多端运行。
...
1. **调试Canvas**: 使用浏览器的H5端进行开发调试，Canvas操作更方便
2. **性能优化**: 注意控制绘制次数和对象数量
3. **多端适配**: 不同平台的Canvas API可能有差异，需要测试
